...
<body>
  <main>
    ...
    <section class="front">
      ...
      <h1 class="text_image">VakApp l'application qui met en relation<br /> les structures hospitalières et le personnel vacataire</h1>
    ...
    <section class="container first_container" id="first_container">
      ...
      <div class="div_button_mobile">
        <button class="button_info" onclick="location.href='https://forms.gle/TDaJYT8JiuBUC4hf9'">Je suis soignant</button>
        <button class="button_info" onclick="location.href='https://forms.gle/kQReDFH7fVB53ftF8'">Je suis une structure de santé</button>
      </div>
      ...
      <article>
        ...
        <p class="p_first_container">Découvrez Vakapp l'application qui a pour vocation de faciliter les vacations. Retrouvez des profils vérifiés, un agenda intégré, notre volonté : la simplicité.
      </article>

      <article>
        <h2>Qui sommes-nous ?</h2>
        <p class="p_first_container">Nous sommes une jeune start-up qui avons des proches qui ont vécu ce problème et nous avons décidé de le résoudre. Nous sommes 10 membres polyvalents et complémentaires qui regroupons nos compétences pour mettre au point l'application qui vise à simplifier et fiabiliser les vacations, dans les structures de la santé.</p>
      </article>
      ...
      <article>
        ...
        <div class="register_images">
          ...
          <div class="flex_div">
            ...
            <p class="flex_text">Trouvez une vacation qui vous est adaptée</p>
          </div>
          <div class="flex_div">
            <img class="flex_images" src="medal.png" alt="medal" />
            <p class="flex_text">Recevez des récompenses pour vos interactions</p>
          </div>
        </div>
      </article>
    ...
    <section class="container">
        ...
        <div class="reseaux_sociaux">
          <p class="reseaux_text reseaux_text_2">Inscrivez vous maintenant et indiquez votre rôle,<br /> pour être parmi les premiers à y avoir accès :</p>
